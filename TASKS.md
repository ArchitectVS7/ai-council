...
### T-001 · v2 branch + clean-room scaffold — `status: TODO` · `coder: opus` · `after: —`
...
### T-002 · Drizzle schema + migrations — `status: TODO` · `coder: opus` · `after: T-001`
...
### T-003 · LLM provider module — `status: TODO` · `coder: opus` · `after: T-001`
...
### T-004 · Seed data + seed script — `status: TODO` · `coder: sonnet` · `after: T-002`
...
### T-005 · CI workflow — `status: TODO` · `coder: sonnet` · `after: T-001`
...
### T-010 · Core domain logic (scheduling, budgeting, prompts) — `status: TODO` · `coder: opus` · `after: T-002`
