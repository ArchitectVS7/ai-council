...
export default function PersonasClient({ personas }: PersonasClientProps) {
  ...
  // Get unique categories from personas
              ...
              <div className="p-6">
                ...
                <div className="mt-4">
                  <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                    ...
                    persona.category === 'coding' ? 'bg-blue-100 text-blue-800' :
                    persona.category === 'ideation' ? 'bg-green-100 text-green-800' :
                    persona.category === 'research' ? 'bg-yellow-100 text-yellow-800' :
